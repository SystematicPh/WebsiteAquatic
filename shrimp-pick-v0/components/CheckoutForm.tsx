      ...
      <Dialog.Root open={open} onOpenChange={setOpen}>
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 w-[92vw] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-[28px] bg-white p-6 shadow-soft">
            <Dialog.Title className="font-display text-3xl">Scan to confirm</Dialog.Title>
            <p className="mt-2 text-sm text-ink/65">Your order has been created. We are opening your live chat room.</p>
